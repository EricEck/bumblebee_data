<div>
    ...
    <div class="md:w-3/4 sm:w-full mx-auto md:my-2 md:py-4 bg-yellow-50 rounded-lg border-gray-100 border shadow-lg">
        ...
        <div class="mx-auto md:px-6 ">
            ...
            <div class="px-4 sm:px-0">
                <h3 class="text-lg font-medium leading-6 text-gray-500 border border-b-2  border-gray-50">{{ $create_new ? 'New' : ($allow_edit ? 'Edit' : 'Information about ') }} Measurement</h3>
            </div>
