...
{{--                @php(debugbar()->info($no_changes))--}}
                ...
                <div class="col-span-6 sm:col-span-3 mt-2">
                    ...
                    <select name="bumblebee_id" id="bumblebee_id"
                            ...
                            @endif
                            <option selected disabled>--Which Bumblebee to Calibrate</option>
                ...
                <div class="col-span-6 sm:col-span-3 mt-4 ml-4 mr-4 border border-4 border-r border-black py-4 px-4 bg-gray-50">
...
{{--            <div class="flow-root mt-6 items-center">--}}
            <div class="mt-6 mb-6 flex flex-row">
                <div class="w-1/2">
